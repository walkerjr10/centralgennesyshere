...
export const ShieldCheckIcon = () => (
  <svg viewBox="0 0 24 24" fill="currentColor">
    <path d="M12 22C8.24 22 4.85 19.93 2.73 16.54C1.42 14.47 0.75 12.04 0.75 9.5C0.75 5.36 4.15 2 8.35 2H15.65C19.85 2 23.25 5.36 23.25 9.5C23.25 12.04 22.58 14.47 21.27 16.54C19.15 19.93 15.76 22 12 22ZM17.41 10.59L11.91 16.09C11.72 16.28 11.47 16.38 11.21 16.38C10.95 16.38 10.7 16.28 10.51 16.09L7.59 13.17C7.2 12.78 7.2 12.15 7.59 11.76C7.98 11.37 8.61 11.37 9 11.76L11.21 13.97L16 9.18C16.39 8.79 17.02 8.79 17.41 9.18C17.8 9.57 17.8 10.2 17.41 10.59Z"/>
  </svg>
);